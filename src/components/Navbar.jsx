        ...
        <>
            <div className="w-full flex justify-between items-center font-semibold">
                <div className="flex items-center gap-2">
                    <img onClick={()=>navigate(-1)} className="glass-diagonal-gradient w-8 bg-black p-2 rounded-2xl cursor-pointer" src={assets.arrow_left} />
                    <img onClick={()=>navigate(+1)} className="glass-diagonal-gradient  w-8 bg-black p-2 rounded-2xl cursor-pointer" src={assets.arrow_right} />
