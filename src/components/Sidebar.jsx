    ...
    return (
        <div className="w-[20%] h-full p-2 flex-col gap-6 text-white hidden lg:flex">
            <div className="h-[25%]  flex flex-col justify-around">
                <div onClick={()=>navigate('/')} className="flex  glass-effect glass-button items-center gap-3 pl-8 cursor-pointer">
                ...
                <div className="flex glass-effect glass-button items-center gap-3 pl-8 cursor-pointer">
                    ...
                    <p  className='text-[13px] font-bold'>Search</p>
                </div>
            </div>
            <div className='glass-effect glass-button h-[85%] rounded'>
                ...
                <div className='p-4 bg-[#242424] glass-card my-8 font-light flex flex-col items-start justify-start gap-1 pl-4'>
                ...
                <div className="p-4 bg-[#242424] glass-card my-8  font-light flex flex-col items-start justify-start gap-1 pl-4 mt-4">
